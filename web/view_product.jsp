...
<html>
    ...
    <body>
      ...
      %>
      <br>
       <section class="category"  style="background:lightgreen;width:100%;height:80px;padding-top:20px">
           <center><h3 style="color:white;"><%=product_name%>&nbsp;Details</h3></center>
       </section>
       <br>
      ...
      <div class="col-lg-5 col-md-5 col-sm-10 col-10 d-block">  
       <div class="card">
      <img class="card-img-top categori" src="getimage_product.jsp?product=<%=product_name%>" style="border: 5px solid #555;"> 
       </div>
      </div>
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="available_quan" value="<%=productquantity%> <%=unit%>" name="quantity" readonly/>
                </div>
                ...
                <center> <button type="submit" class="btn btn-secondary" name="buy">Back</button></center>
              </form>
       </div> 
       </div>
        </div> 
