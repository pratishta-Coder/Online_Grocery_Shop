<%-- 
    Document   : Todays_profit
    Created on : 26-Nov-2020, 1:13:09 pm
    Author     : Shree
--%>
...
<html>
    ...
    <body>
        ...
        <section class="category" style="background: peru;width:100%;height:80px;padding-top:20px">
            <center><h3>Today's Profit Information</h3></center>
        </section>
        <br>
        ...
        <%
             ...
             try{
                   ...
                   rs=pt.executeQuery("select * from sell_history where DATE(Date)=CURDATE()");
                     while(rs.next())
                        {
                          todaysprofit+=rs.getInt(9);
                         %>
                   ...
                   %>
                   <tr><td colspan='4' class='text-right font-weight-bold'>Today's Profit: &#8377;<%=todaysprofit%></td></tr>          
          </tbody>     
        </table>
