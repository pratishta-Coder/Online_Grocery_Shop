<%-- 
    ...
    Created on : 27-Nov-2020, 2:20:24 pm
    Author     : Shree
--%>
        ...
        <div class="row">
          ...
          <div class="col-md-6">
                <div class="card">
                 ...
                 <div class="card-body">
                     <form name="myform" method="post" action="order_cart.jsp">
                       ...
                       <div class="form-group">
                         ...
                         <div class="form-group">
                          ...
                          <div class="form-group">
                           ...
                           <input type="text" id="price" class="form-control" value="<%=totalquan%>&#8377;" readonly/>
                           </div>
